...
import { ICON_BULLETIN, ICON_SCOUT, ICON_DIGEST, ICON_SWARM, KB_FLOW, SWARM_FANOUT } from "./icons";
...
export const slides: Slide[] = [
  // ── 1. The gap ────────────────────────────────────────────────────────────
  {
    ...
    layout: "left",
    elements: [
      { kind: "headline", text: "CUGA is powerful.\nHow can we get more users to use it?" },
      {
        kind: "body",
        text: "Consumer agents are everywhere. They listen on your channels, act on a schedule, and can field a team when needed. CUGA was enterprise-grade but missing key user-oriented features.",
      },
      {
        kind: "chips",
